...
tools = require('renderkid/lib/tools');
SpecialString = require('renderkid/lib/layout/SpecialString');
...
module.exports = DefaultLinePrependor = function () {
  ...
  }(require('renderkid/lib/layout/block/linePrependor/_LinePrependor'));

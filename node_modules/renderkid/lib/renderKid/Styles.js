...
StyleSheet = require('renderkid/lib/renderKid/styles/StyleSheet');
MixedDeclarationSet = require('renderkid/lib/renderKid/styles/rule/MixedDeclarationSet');
terminalWidth = require('renderkid/lib/tools').getCols();

...
const { dirname, join, mkdirp } = require("webpack/lib/util/fs");
const memoize = require("webpack/lib/util/memoize");
const SerializerMiddleware = require("webpack/lib/serialization/SerializerMiddleware");
...
/** @typedef {import("webpack/lib/serialization/types").BufferSerializableType} BufferSerializableType */

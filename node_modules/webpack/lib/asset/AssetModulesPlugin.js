...
const validateGeneratorOptions = {
	asset: createSchemaValidation(
		require("webpack/schemas/plugins/asset/AssetGeneratorOptions.check.js"),
		() => getSchema("AssetGeneratorOptions"),
		generatorValidationOptions
	),
	"asset/resource": createSchemaValidation(
		require("webpack/schemas/plugins/asset/AssetResourceGeneratorOptions.check.js"),
		() => getSchema("AssetResourceGeneratorOptions"),
		generatorValidationOptions
	),
	"asset/inline": createSchemaValidation(
		require("webpack/schemas/plugins/asset/AssetInlineGeneratorOptions.check.js"),
...
const validateParserOptions = createSchemaValidation(
	require("webpack/schemas/plugins/asset/AssetParserOptions.check.js"),
...
const getAssetGenerator = memoize(() => require("webpack/lib/asset/AssetGenerator"));
const getAssetParser = memoize(() => require("webpack/lib/asset/AssetParser"));
const getAssetSourceParser = memoize(() => require("webpack/lib/asset/AssetSourceParser"));
const getAssetSourceGenerator = memoize(() =>
	require("webpack/lib/asset/AssetSourceGenerator")
);

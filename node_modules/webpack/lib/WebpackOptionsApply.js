...
const OptionsApply = require("webpack/lib/OptionsApply");

const AssetModulesPlugin = require("webpack/lib/asset/AssetModulesPlugin");
const JavascriptModulesPlugin = require("webpack/lib/javascript/JavascriptModulesPlugin");
const JsonModulesPlugin = require("webpack/lib/json/JsonModulesPlugin");

const ChunkPrefetchPreloadPlugin = require("webpack/lib/prefetch/ChunkPrefetchPreloadPlugin");

const EntryOptionPlugin = require("webpack/lib/EntryOptionPlugin");
const RecordIdsPlugin = require("webpack/lib/RecordIdsPlugin");

const RuntimePlugin = require("webpack/lib/RuntimePlugin");

const APIPlugin = require("webpack/lib/APIPlugin");
const CompatibilityPlugin = require("webpack/lib/CompatibilityPlugin");
const ConstPlugin = require("webpack/lib/ConstPlugin");
const ExportsInfoApiPlugin = require("webpack/lib/ExportsInfoApiPlugin");
const WebpackIsIncludedPlugin = require("webpack/lib/WebpackIsIncludedPlugin");
...
const DataUriPlugin = require("webpack/lib/schemes/DataUriPlugin");
const FileUriPlugin = require("webpack/lib/schemes/FileUriPlugin");

const ResolverCachePlugin = require("webpack/lib/cache/ResolverCachePlugin");

const CommonJsPlugin = require("webpack/lib/dependencies/CommonJsPlugin");
const HarmonyModulesPlugin = require("webpack/lib/dependencies/HarmonyModulesPlugin");
const ImportMetaContextPlugin = require("webpack/lib/dependencies/ImportMetaContextPlugin");
const ImportMetaPlugin = require("webpack/lib/dependencies/ImportMetaPlugin");
const ImportPlugin = require("webpack/lib/dependencies/ImportPlugin");
const LoaderPlugin = require("webpack/lib/dependencies/LoaderPlugin");
const RequireContextPlugin = require("webpack/lib/dependencies/RequireContextPlugin");
const RequireEnsurePlugin = require("webpack/lib/dependencies/RequireEnsurePlugin");
const RequireIncludePlugin = require("webpack/lib/dependencies/RequireIncludePlugin");
const SystemPlugin = require("webpack/lib/dependencies/SystemPlugin");
const URLPlugin = require("webpack/lib/dependencies/URLPlugin");
const WorkerPlugin = require("webpack/lib/dependencies/WorkerPlugin");

const InferAsyncModulesPlugin = require("webpack/lib/async-modules/InferAsyncModulesPlugin");

const JavascriptMetaInfoPlugin = require("webpack/lib/JavascriptMetaInfoPlugin");
const DefaultStatsFactoryPlugin = require("webpack/lib/stats/DefaultStatsFactoryPlugin");
const DefaultStatsPresetPlugin = require("webpack/lib/stats/DefaultStatsPresetPlugin");
const DefaultStatsPrinterPlugin = require("webpack/lib/stats/DefaultStatsPrinterPlugin");
...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		if (options.externalsPresets.electronMain) {
			// @ts-expect-error https://github.com/microsoft/TypeScript/issues/41697
			const ElectronTargetPlugin = require("webpack/lib/electron/ElectronTargetPlugin");
		...
		if (typeof options.output.chunkFormat === "string") {
			switch (options.output.chunkFormat) {
				...
				case "module": {
					const ModuleChunkFormatPlugin = require("webpack/lib/esm/ModuleChunkFormatPlugin");
		...
		if (enabledWasmLoadingTypes.length > 0) {
			for (const type of enabledWasmLoadingTypes) {
				const EnableWasmLoadingPlugin = require("webpack/lib/wasm/EnableWasmLoadingPlugin");
		...
		if (options.output.clean) {
			const CleanPlugin = require("webpack/lib/CleanPlugin");
			new CleanPlugin(
		...
		if (options.devtool) {
			if (options.devtool.includes("source-map")) {
				...
				const Plugin = evalWrapped
					? require("webpack/lib/EvalSourceMapDevToolPlugin")
					: require("webpack/lib/SourceMapDevToolPlugin");
				new Plugin({
				...
				const EvalDevToolModulePlugin = require("webpack/lib/EvalDevToolModulePlugin");
		...
		if (options.experiments.syncWebAssembly) {
			const WebAssemblyModulesPlugin = require("webpack/lib/wasm-sync/WebAssemblyModulesPlugin");
		...
		if (options.experiments.asyncWebAssembly) {
			const AsyncWebAssemblyModulesPlugin = require("webpack/lib/wasm-async/AsyncWebAssemblyModulesPlugin");
		...
		if (options.experiments.css) {
			const CssModulesPlugin = require("webpack/lib/css/CssModulesPlugin");
			new CssModulesPlugin().apply(compiler);
		}

		if (options.experiments.lazyCompilation) {
			const LazyCompilationPlugin = require("webpack/lib/hmr/LazyCompilationPlugin");
			const lazyOptions =
			...
			new LazyCompilationPlugin({
				backend:
					typeof lazyOptions.backend === "function"
						? lazyOptions.backend
						: require("webpack/lib/hmr/lazyCompilationBackend")({
								...lazyOptions.backend,
								client:
		...
		if (options.experiments.buildHttp) {
			const HttpUriPlugin = require("webpack/lib/schemes/HttpUriPlugin");
		...
		if (options.amd !== false) {
			const AMDPlugin = require("webpack/lib/dependencies/AMDPlugin");
			const RequireJsStuffPlugin = require("webpack/lib/RequireJsStuffPlugin");
		...
		if (typeof options.mode !== "string") {
			const WarnNoModeSetPlugin = require("webpack/lib/WarnNoModeSetPlugin");
			new WarnNoModeSetPlugin().apply(compiler);
		}

		const EnsureChunkConditionsPlugin = require("webpack/lib/optimize/EnsureChunkConditionsPlugin");
		...
		if (options.optimization.innerGraph) {
			const InnerGraphPlugin = require("webpack/lib/optimize/InnerGraphPlugin");
			new InnerGraphPlugin().apply(compiler);
		}
		if (options.optimization.mangleExports) {
			const MangleExportsPlugin = require("webpack/lib/optimize/MangleExportsPlugin");
		...
		if (options.optimization.realContentHash) {
			const RealContentHashPlugin = require("webpack/lib/optimize/RealContentHashPlugin");
		...
		if (options.optimization.checkWasmTypes) {
			const WasmFinalizeExportsPlugin = require("webpack/lib/wasm-sync/WasmFinalizeExportsPlugin");
		...
		if (moduleIds) {
			switch (moduleIds) {
				case "natural": {
					const NaturalModuleIdsPlugin = require("webpack/lib/ids/NaturalModuleIdsPlugin");
					new NaturalModuleIdsPlugin().apply(compiler);
					break;
				}
				case "named": {
					const NamedModuleIdsPlugin = require("webpack/lib/ids/NamedModuleIdsPlugin");
					new NamedModuleIdsPlugin().apply(compiler);
					break;
				}
				case "hashed": {
					const WarnDeprecatedOptionPlugin = require("webpack/lib/WarnDeprecatedOptionPlugin");
				...
				case "size": {
					const OccurrenceModuleIdsPlugin = require("webpack/lib/ids/OccurrenceModuleIdsPlugin");
		...
		if (chunkIds) {
			switch (chunkIds) {
				...
				case "named": {
					const NamedChunkIdsPlugin = require("webpack/lib/ids/NamedChunkIdsPlugin");
				...
				case "size": {
					// @ts-expect-error https://github.com/microsoft/TypeScript/issues/41697
					const OccurrenceChunkIdsPlugin = require("webpack/lib/ids/OccurrenceChunkIdsPlugin");
		...
		const AddManagedPathsPlugin = require("webpack/lib/cache/AddManagedPathsPlugin");
			...
			switch (cacheOptions.type) {
				case "memory": {
					if (Number.isFinite(cacheOptions.maxGenerations)) {
						// @ts-expect-error https://github.com/microsoft/TypeScript/issues/41697
						const MemoryWithGcCachePlugin = require("webpack/lib/cache/MemoryWithGcCachePlugin");
						...
						// @ts-expect-error https://github.com/microsoft/TypeScript/issues/41697
						const MemoryCachePlugin = require("webpack/lib/cache/MemoryCachePlugin");
				...
				case "filesystem": {
					const AddBuildDependenciesPlugin = require("webpack/lib/cache/AddBuildDependenciesPlugin");
					...
					switch (cacheOptions.store) {
						case "pack": {
							const IdleFileCachePlugin = require("webpack/lib/cache/IdleFileCachePlugin");

...
const CssModule = require("webpack/lib/CssModule");
const { tryRunOrWebpackError } = require("webpack/lib/HookWebpackError");
const HotUpdateChunk = require("webpack/lib/HotUpdateChunk");
const {
	CSS_MODULE_TYPE,
...
const SelfModuleFactory = require("webpack/lib/SelfModuleFactory");
const WebpackError = require("webpack/lib/WebpackError");
const CssExportDependency = require("webpack/lib/dependencies/CssExportDependency");
const CssImportDependency = require("webpack/lib/dependencies/CssImportDependency");
const CssLocalIdentifierDependency = require("webpack/lib/dependencies/CssLocalIdentifierDependency");
const CssSelfLocalIdentifierDependency = require("webpack/lib/dependencies/CssSelfLocalIdentifierDependency");
const CssUrlDependency = require("webpack/lib/dependencies/CssUrlDependency");
...
const nonNumericOnlyHash = require("webpack/lib/util/nonNumericOnlyHash");
const CssExportsGenerator = require("webpack/lib/css/CssExportsGenerator");
const CssGenerator = require("webpack/lib/css/CssGenerator");
const CssParser = require("webpack/lib/css/CssParser");
...
/** @typedef {import("webpack/lib/CssModule").Inheritance} Inheritance */
/** @typedef {import("webpack/lib/DependencyTemplate").CssExportsData} CssExportsData */
/** @typedef {import("webpack/lib/Module")} Module */
/** @typedef {import("webpack/lib/Template").RuntimeTemplate} RuntimeTemplate */
/** @typedef {import("webpack/lib/TemplatedPathPlugin").TemplatePath} TemplatePath */
/** @typedef {import("webpack/lib/util/Hash")} Hash */
/** @typedef {import("webpack/lib/util/memoize")} Memoize */
...
const getCssLoadingRuntimeModule = memoize(() =>
	require("webpack/lib/css/CssLoadingRuntimeModule")
);
...
const getSchema = name => {
	const { definitions } = require("webpack/schemas/WebpackOptions.json");
	return {
		definitions,
...
const validateGeneratorOptions = {
	css: createSchemaValidation(
		require("webpack/schemas/plugins/css/CssGeneratorOptions.check.js"),
		() => getSchema("CssGeneratorOptions"),
		generatorValidationOptions
	),
	"css/auto": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssAutoGeneratorOptions.check.js"),
		() => getSchema("CssAutoGeneratorOptions"),
		generatorValidationOptions
	),
	"css/module": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssModuleGeneratorOptions.check.js"),
		() => getSchema("CssModuleGeneratorOptions"),
		generatorValidationOptions
	),
	"css/global": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssGlobalGeneratorOptions.check.js"),
...
const validateParserOptions = {
	css: createSchemaValidation(
		require("webpack/schemas/plugins/css/CssParserOptions.check.js"),
		() => getSchema("CssParserOptions"),
		parserValidationOptions
	),
	"css/auto": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssAutoParserOptions.check.js"),
		() => getSchema("CssAutoParserOptions"),
		parserValidationOptions
	),
	"css/module": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssModuleParserOptions.check.js"),
		() => getSchema("CssModuleParserOptions"),
		parserValidationOptions
	),
	"css/global": createSchemaValidation(
		require("webpack/schemas/plugins/css/CssGlobalParserOptions.check.js"),
							...
							if (resolveData.dependencies.length > 0) {
								...
								if (dependency instanceof CssImportDependency) {
									...
									if (parent instanceof CssModule) {
										/** @type {import("webpack/lib/CssModule").Inheritance | undefined} */
										let inheritance;

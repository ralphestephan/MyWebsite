...
const { STAGE_ADVANCED } = require("webpack/lib/OptimizationStages");
const LazyBucketSortedSet = require("webpack/lib/util/LazyBucketSortedSet");
const { compareChunks } = require("webpack/lib/util/comparators");
...
const validate = createSchemaValidation(
	require("webpack/schemas/plugins/optimize/LimitChunkCountPlugin.check.js"),
	() => require("webpack/schemas/plugins/optimize/LimitChunkCountPlugin.json"),
	{

...
const { last, someInIterable } = require("webpack/lib/util/IterableHelpers");
...
const { getPathInAst, getAllReferences } = require("webpack/lib/util/mergeScope");
const nonNumericOnlyHash = require("webpack/lib/util/nonNumericOnlyHash");
const { intersectRuntime } = require("webpack/lib/util/runtime");

...
const { STAGE_DEFAULT } = require("webpack/lib/OptimizationStages");
const ArrayQueue = require("webpack/lib/util/ArrayQueue");
const TupleQueue = require("webpack/lib/util/TupleQueue");
const { getEntryRuntime, mergeRuntimeOwned } = require("webpack/lib/util/runtime");

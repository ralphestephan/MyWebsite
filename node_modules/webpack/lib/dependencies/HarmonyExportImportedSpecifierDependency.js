...
const ConditionalInitFragment = require("webpack/lib/ConditionalInitFragment");
const Dependency = require("webpack/lib/Dependency");
const { UsageState } = require("webpack/lib/ExportsInfo");
const HarmonyLinkingError = require("webpack/lib/HarmonyLinkingError");
...
const { first, combine } = require("webpack/lib/util/SetHelpers");
const makeSerializable = require("webpack/lib/util/makeSerializable");
const propertyAccess = require("webpack/lib/util/propertyAccess");
const { propertyName } = require("webpack/lib/util/propertyName");
const {
	getRuntimeKey,
	keyToRuntime,
	filterRuntime
} = require("webpack/lib/util/runtime");
const HarmonyExportInitFragment = require("webpack/lib/dependencies/HarmonyExportInitFragment");
const HarmonyImportDependency = require("webpack/lib/dependencies/HarmonyImportDependency");
const processExportInfo = require("webpack/lib/dependencies/processExportInfo");

/** @typedef {import("webpack-sources").ReplaceSource} ReplaceSource */
/** @typedef {import("webpack/lib/ChunkGraph")} ChunkGraph */
/** @typedef {import("webpack/lib/Dependency").ExportsSpec} ExportsSpec */
/** @typedef {import("webpack/lib/Dependency").GetConditionFn} GetConditionFn */
/** @typedef {import("webpack/lib/Dependency").ReferencedExport} ReferencedExport */
/** @typedef {import("webpack/lib/Dependency").TRANSITIVE} TRANSITIVE */
...
/** @typedef {import("webpack/lib/ExportsInfo")} ExportsInfo */
/** @typedef {import("webpack/lib/ExportsInfo").ExportInfo} ExportInfo */
/** @typedef {import("webpack/lib/ExportsInfo").UsedName} UsedName */
/** @typedef {import("webpack/lib/Generator").GenerateContext} GenerateContext */
/** @typedef {import("webpack/lib/Module")} Module */
/** @typedef {import("webpack/lib/Module").BuildMeta} BuildMeta */
/** @typedef {import("webpack/lib/Module").RuntimeRequirements} RuntimeRequirements */
...
/** @typedef {import("webpack/lib/javascript/JavascriptParser").ImportAttributes} ImportAttributes */
...
/** @typedef {import("webpack/lib/dependencies/processExportInfo").ReferencedExports} ReferencedExports */

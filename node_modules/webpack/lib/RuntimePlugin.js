...
const { getChunkFilenameTemplate } = require("webpack/lib/css/CssModulesPlugin");
const RuntimeRequirementsDependency = require("webpack/lib/dependencies/RuntimeRequirementsDependency");
const JavascriptModulesPlugin = require("webpack/lib/javascript/JavascriptModulesPlugin");
const AsyncModuleRuntimeModule = require("webpack/lib/runtime/AsyncModuleRuntimeModule");
const AutoPublicPathRuntimeModule = require("webpack/lib/runtime/AutoPublicPathRuntimeModule");
const BaseUriRuntimeModule = require("webpack/lib/runtime/BaseUriRuntimeModule");
const CompatGetDefaultExportRuntimeModule = require("webpack/lib/runtime/CompatGetDefaultExportRuntimeModule");
const CompatRuntimeModule = require("webpack/lib/runtime/CompatRuntimeModule");
const CreateFakeNamespaceObjectRuntimeModule = require("webpack/lib/runtime/CreateFakeNamespaceObjectRuntimeModule");
const CreateScriptRuntimeModule = require("webpack/lib/runtime/CreateScriptRuntimeModule");
const CreateScriptUrlRuntimeModule = require("webpack/lib/runtime/CreateScriptUrlRuntimeModule");
const DefinePropertyGettersRuntimeModule = require("webpack/lib/runtime/DefinePropertyGettersRuntimeModule");
const EnsureChunkRuntimeModule = require("webpack/lib/runtime/EnsureChunkRuntimeModule");
const GetChunkFilenameRuntimeModule = require("webpack/lib/runtime/GetChunkFilenameRuntimeModule");
const GetMainFilenameRuntimeModule = require("webpack/lib/runtime/GetMainFilenameRuntimeModule");
const GetTrustedTypesPolicyRuntimeModule = require("webpack/lib/runtime/GetTrustedTypesPolicyRuntimeModule");
const GlobalRuntimeModule = require("webpack/lib/runtime/GlobalRuntimeModule");
const HasOwnPropertyRuntimeModule = require("webpack/lib/runtime/HasOwnPropertyRuntimeModule");
const LoadScriptRuntimeModule = require("webpack/lib/runtime/LoadScriptRuntimeModule");
const MakeNamespaceObjectRuntimeModule = require("webpack/lib/runtime/MakeNamespaceObjectRuntimeModule");
const NonceRuntimeModule = require("webpack/lib/runtime/NonceRuntimeModule");
const OnChunksLoadedRuntimeModule = require("webpack/lib/runtime/OnChunksLoadedRuntimeModule");
const PublicPathRuntimeModule = require("webpack/lib/runtime/PublicPathRuntimeModule");
const RelativeUrlRuntimeModule = require("webpack/lib/runtime/RelativeUrlRuntimeModule");
const RuntimeIdRuntimeModule = require("webpack/lib/runtime/RuntimeIdRuntimeModule");
const SystemContextRuntimeModule = require("webpack/lib/runtime/SystemContextRuntimeModule");

...
const middleware = require("webpack-dev-middleware/dist/middleware");
const getFilenameFromUrl = require("webpack-dev-middleware/dist/utils/getFilenameFromUrl");
const setupHooks = require("webpack-dev-middleware/dist/utils/setupHooks");
const setupWriteToDisk = require("webpack-dev-middleware/dist/utils/setupWriteToDisk");
const setupOutputFileSystem = require("webpack-dev-middleware/dist/utils/setupOutputFileSystem");
const ready = require("webpack-dev-middleware/dist/utils/ready");
const schema = require("webpack-dev-middleware/dist/options.json");
const noop = () => {};
...
/** @typedef {import("webpack-dev-middleware/dist/utils/getFilenameFromUrl").Extra} Extra */
...
function koaWrapper(compiler, options) {
  ...
  /**
   * @param {{ req: RequestInternal, res: ResponseInternal & import("webpack-dev-middleware/dist/utils/compatibleAPI").ExpectedServerResponse, status: number, body: string | Buffer | import("fs").ReadStream | { message: string }, state: Object }} ctx
   * @param {Function} next
...
function honoWrapper(compiler, options) {
  ...
  /**
   * @param {{ env: any, body: any, json: any, status: any, set:any, req: RequestInternal & import("webpack-dev-middleware/dist/utils/compatibleAPI").ExpectedIncomingMessage & { header: (name: string) => string }, res: ResponseInternal & import("./utils/compatibleAPI").ExpectedServerResponse & { headers: any, status: any } }} c
   * @param {Function} next
   * @returns {Promise<void>}
   */

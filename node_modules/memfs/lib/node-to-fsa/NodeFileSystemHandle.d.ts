import { NodePermissionStatus } from 'memfs/lib/node-to-fsa/NodePermissionStatus';
import type { IFileSystemHandle, FileSystemHandlePermissionDescriptor } from 'memfs/lib/fsa/types';
/**

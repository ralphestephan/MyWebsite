import type { FileSystemReadWriteOptions, IFileSystemSyncAccessHandle } from 'memfs/lib/fsa/types';
import type { NodeFsaContext, NodeFsaFs } from 'memfs/lib/node-to-fsa/types';
/**

...
import { isBlock, isFunc, isIdentifier, numberLiteralFromRaw, traverse } from "@webassemblyjs/ast";
import { moduleContextFromModuleAST } from "@webassemblyjs/ast/lib/transform/ast-module-to-module-context"; // FIXME(sven): do the same with all block instructions, must be more generic here
